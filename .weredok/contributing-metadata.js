module.exports = [{
  name: "metadata",
  code: ` 
  $title[1;$splittext[1]$textSplit[$splitText[2]$textSplit[$httpRequest[https://raw.githubusercontent.com/Weredok/docs/dev/functions/usd$tolowercase[$replacetext[$message[1];$;]];#];
